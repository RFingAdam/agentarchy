...
description: >
  ...
  Covers reporting a confirmed Agentarchy bug upstream — see reporting.md.
---
...
## If it is an Agentarchy bug

Most application crashes are upstream bugs in those applications, not Agentarchy's
doing. In the minority of cases where the cause really does sit within Agentarchy's
